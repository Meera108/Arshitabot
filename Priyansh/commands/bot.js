...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "Oye") || (event.body.toLowerCase() == "Aaja") || (event.body.toLowerCase() == "@Bulbul") || (event.body.toLowerCase() == "Bulbul bot")) {
     return api.sendMessage("Bolo Ji Kya Hua Kya Kaam Hai BulBul Se ☺️🥲", threadID);
   };

   if ((event.body.toLowerCase() == "Dev") || (event.body.toLowerCase() == "@Dev Vardhan")) {
